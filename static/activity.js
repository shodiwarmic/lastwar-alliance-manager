...
const ENTITY_LABELS = {
    ...
    strike_type:           'strike category',
    participation_board:   'participation board',
    participation_exception: 'participation excuse/dismissal',
    ...
    season_reward_tier:    'season reward tier',
...
const ENTITY_LABELS_PLURAL = {
    ...
    strike_type:           'strike categories',
    participation_board:   'participation boards',
    season_contributions:  'season contributions',
    ...
    season_reward_tier:    'season reward tiers',
