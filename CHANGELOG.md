...
- **Desert Storm battles on the schedule** — one event per task force, generated every Friday
  ...
  task force chosen. They replace the display-only Friday entries everywhere the schedule is
  drawn, exported and announced. The Storm page gets **Record last battle**, which prefills the
